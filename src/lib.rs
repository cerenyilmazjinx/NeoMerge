...
#[derive(Debug)]
pub struct NeoMergeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoMergeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoMerge processing");
    
    let mut processor = NeoMergeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoMergeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoMergeProcessor::new(false);
